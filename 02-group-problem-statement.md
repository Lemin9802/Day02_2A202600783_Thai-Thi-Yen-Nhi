...
| :--- | :--- |
| **Kế hoạch di chuyển HCM - HN học AI:** tìm combo chỗ ở rẻ, gym, ăn uống từ MXH | Đây là bài toán rất thực tế và có pain point rõ, đặc biệt với người đi học xa nhà cần tối ưu chi phí. Tuy nhiên, phần thu thập dữ liệu đầu vào từ Facebook, TikTok hoặc các nguồn mạng xã hội có thể làm workflow trở nên phức tạp. Ngoài ra, dữ liệu từ MXH dễ nhiễu, khó kiểm chứng và có rủi ro sai lệch thông tin như giá thuê, vị trí, lừa đảo hoặc bài đăng hết hiệu lực. Vì vậy, dù AI value khá rõ, nhóm chưa chọn vì độ phức tạp dữ liệu đầu vào còn cao so với phạm vi lab. |
| **Debug training model AI** | Pain point rất thật với sinh viên làm đồ án AI, vì lỗi training có thể nằm ở dataset, mask, dataloader, loss, scheduler, learning rate, optimizer hoặc architecture. Tuy nhiên, bài toán này phù hợp hơn với nhóm người học AI/ML, phạm vi người dùng hẹp hơn. Ngoài ra, để Agent debug tốt cần truy cập code, log, biểu đồ metric và hiểu context mô hình, nên độ phức tạp kỹ thuật khá cao trong thời gian lab. |
| **Chỉnh sửa/xoá dữ liệu ngân hàng câu hỏi, đầu sách khi có typo** | Đây là vấn đề thực tế trong quy trình data entry, giúp giảm lỗi nhập liệu và giảm tải cho đội ngũ vận hành dữ liệu. Tuy nhiên, bài toán thiên nhiều về tính năng CRUD/quản trị dữ liệu hơn là một workflow cần AI Agent. Phần AI value chưa thật sự nổi bật nếu chỉ dừng ở việc sửa hoặc xoá dữ liệu sai. Ngoài ra, nhóm chưa chắc về quy trình dữ liệu sau khi chỉnh sửa có được cập nhật đồng bộ vào hệ thống chính hay không. |
| **Tìm tài liệu học tập** | Đây là nhu cầu phổ biến của sinh viên, nhưng phạm vi khá rộng và khó kiểm soát trong thời gian lab. Nếu không thu hẹp rõ nguồn tài liệu, môn học, tiêu chí đánh giá và đầu ra mong muốn, bài toán sẽ khó validate nhanh. Ngoài ra, tìm tài liệu đơn thuần có thể được giải quyết bằng search engine hoặc chatbot thông thường, nên AI Agent value chưa đủ rõ nếu không gắn với một workflow cụ thể. |
